# Домашнее задание к занятию "`Обзор систем IT-мониторинга`" - `Дунаев Дмитрий`
...
![дашборд](https://github.com/duskdemon/sys-29-smon-01/blob/main/img/hw-01-vmyc-dash.png)
